...
/**
 * Ventana principal a la que llega un Proveedor tras iniciar sesión.
 *
 ...
 * espacio de trabajo del Proveedor necesita ser amplio (catálogo, tablas,
 * herramientas), así que se abre más grande, con un tamaño fijo de
 * 1024×680 y sin opción de redimensionar ni maximizar: el contenido está
 * compuesto para ese tamaño y estirarlo lo descompone.</p>
 *
 ...
 *
 * <p>Pantalla mínima a propósito: no hay todavía caso de uso de gestión de
 * catálogo, así que no tiene controlador propio. Cuando ese incremento lo
 * requiera, esta clase crece (o un {@code ProveedorController} pasa a
 ...
 * @version 1.1
 */
public class ProviderDashboardFrame extends JFrame {
     ...
     */
    public ProviderDashboardFrame(IComponentesFactory fabrica, String nombreUsuario, Runnable alCerrarSesion) {
    ...
    private JPanel construirCuerpo(IComponentesFactory fabrica) {
        ...
        JLabel lblMensaje = new JLabel(
                "Aquí gestionarás tu catálogo de productos en un próximo incremento.",
